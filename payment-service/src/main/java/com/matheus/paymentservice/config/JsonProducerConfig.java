package com.matheus.paymentservice.config;
...
public class JsonProducerConfig {
    ...
    public ProducerFactory jsonProducerFactory(){
        ...
        configs.put(ProducerConfig.VALUE_SERIALIZER_CLASS_CONFIG, JsonSerializer.class); //definir o serializador do valor
